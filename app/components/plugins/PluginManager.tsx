...
import { pluginSystem, type InstalledPlugin, type PluginType, type PluginStatus } from '~/lib/plugins/PluginSystem';
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                <div className="i-ph:puzzle-piece-duotone text-2xl" style={{ color: colors.primary }} />
                <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-4 text-sm mr-4">
                  <div className="flex items-center gap-1">
                    ...
                    <span style={{ color: colors.text.secondary }}>{systemStats.active} نشط</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <div className="w-2 h-2 rounded-full" style={{ backgroundColor: colors.text.secondary }} />
                    <span style={{ color: colors.text.secondary }}>{systemStats.total} إجمالي</span>
                  </div>
                </div>
            ...
            <div className="flex h-full">
              {/* Sidebar */}
              <div className="w-80 border-r flex flex-col" style={{ borderColor: colors.border.primary }}>
                {/* Search */}
                ...
                <div className="flex-1 overflow-auto">
                  {filteredPlugins.length === 0 ? (
                    <div className="p-4 text-center">
                      <div className="i-ph:package text-4xl mb-2" style={{ color: colors.text.secondary }} />
                      <div className="text-sm" style={{ color: colors.text.secondary }}>
                        لا توجد إضافات
                      </div>
                    </div>
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              >
                                {plugin.plugin.manifest.icon ? (
                                  ...
                                  <div className="i-ph:puzzle-piece text-lg" style={{ color: colors.primary }} />
                                )}
                              </div>
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="text-xs truncate mb-1" style={{ color: colors.text.secondary }}>
                                ...
                                <div className="flex items-center gap-2 text-xs">
                                  ...
                                  <span style={{ color: colors.text.tertiary }}>v{plugin.plugin.manifest.version}</span>
                                </div>
                              </div>
                            </div>
                          </button>
              ...
              <div className="flex-1 flex flex-col">
                {selectedPlugin ? (
                  ...
                  >
                    ...
                    <div className="p-6 border-b" style={{ borderColor: colors.border.primary }}>
                      <div className="flex items-start gap-4">
                        ...
                        >
                          {selectedPlugin.plugin.manifest.icon ? (
                            ...
                            <div className="i-ph:puzzle-piece text-2xl" style={{ color: colors.primary }} />
                          )}
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Switch.Root
                              ...
                              style={{
                                backgroundColor:
                                  selectedPlugin.status === 'active' ? colors.status.success : colors.surface.elevated,
                              }}
                            >
                              <Switch.Thumb
                          ...
                          <button
                            ...
                            disabled={isLoading}
                            className="px-3 py-1.5 text-sm rounded-lg border transition-colors hover:scale-105 disabled:opacity-50"
                            style={{
                              backgroundColor: colors.surface.elevated,
                    ...
                    <div className="flex-1 overflow-auto p-6">
                      <Tabs.Root defaultValue="info" className="h-full">
                        <Tabs.List className="flex border-b mb-6" style={{ borderColor: colors.border.primary }}>
                          {[
                            ...
                            <Tabs.Trigger
                              key={tab.id}
                              value={tab.id}
                              className="flex items-center gap-2 px-4 py-2 text-sm font-medium transition-colors border-b-2 border-transparent data-[state=active]:border-current"
                              style={{ color: colors.text.secondary }}
                            >
                            ...
                            <div>
                              ...
                              <div className="space-y-2 text-sm">
                                <div className="flex justify-between">
                                  <span style={{ color: colors.text.secondary }}>المعرف:</span>
                                  <span style={{ color: colors.text.primary }}>{selectedPlugin.context.id}</span>
                                </div>
                                <div className="flex justify-between">
                                  <span style={{ color: colors.text.secondary }}>النوع:</span>
                                  <span style={{ color: colors.text.primary }}>
                                    {selectedPlugin.plugin.manifest.type}
                                  </span>
                                </div>
                                <div className="flex justify-between">
                                  <span style={{ color: colors.text.secondary }}>تاريخ التثبيت:</span>
                                  <span style={{ color: colors.text.primary }}>
                                    {selectedPlugin.installDate.toLocaleDateString('ar-SA')}
                                  </span>
                                </div>
                                <div className="flex justify-between">
                                  <span style={{ color: colors.text.secondary }}>آخر استخدام:</span>
                                  <span style={{ color: colors.text.primary }}>
                          ...
                          {selectedPlugin.plugin.manifest.keywords && (
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2">
                                {selectedPlugin.plugin.manifest.keywords.map((keyword, index) => (
                                  <span
                                    key={index}
                        ...
                        <Tabs.Content value="config" className="space-y-4">
                          ...
                          >
                            <div className="i-ph:gear-duotone text-4xl mb-2" style={{ color: colors.primary }} />
                            <div className="text-sm" style={{ color: colors.text.secondary }}>
                        ...
                        <Tabs.Content value="permissions" className="space-y-4">
                          <div>
                            ...
                            <div className="space-y-2">
                              {selectedPlugin.plugin.manifest.permissions.map((permission, index) => (
                                <div
                                  key={index}
                  ...
                  <div className="flex-1 flex items-center justify-center">
                    <div className="text-center">
                      <div className="i-ph:cursor-click text-6xl mb-4" style={{ color: colors.text.secondary }} />
